...
public class FireRateBonus extends ABonus implements ISpaceShipBonus
{
	/**
	 * Build a FireRateBonus.
	 *
	 ...
	 *
	 */
	public FireRateBonus(Point2D.Double pos, Point2D.Double _vecDir, double _speed, double _life)
	{
		super(pos,_vecDir, _speed, _life);
		image = GetImage.getFireRateBonusImage();
	}
	...
	/**
	 * Launch the effect of the FireRateBonus.
	 *
	 * @param s a SpaceShip
	 *
	 */
