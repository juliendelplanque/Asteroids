/**
 * Class MissileLifeBonus.
 * Create a MissileLifeBonus.
...
public class MissileLifeBonus extends ABonus implements ISpaceShipBonus
{
	/**
	 * Build a MissileLifeBonus.
	 *
	 ...
	 *
	 */
	public MissileLifeBonus(Point2D.Double pos, Point2D.Double _vecDir, double _speed, double _life)
	{
		super(pos,_vecDir, _speed, _life);
		image = GetImage.getMissileLifeBonusImage();
	}
	...
	/**
	 * Launch the effect of the MissileLifeBonus.
	 *
	 * @param s a SpaceShip
	 *
	 */
